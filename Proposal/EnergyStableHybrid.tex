...
will be construction of an interface between structured (finite difference SBP)
...
It can be shown (see \cite{kozdon2016stable}, Appendix A) that the energy dissipation rate
...
as the ones defined by \eref{eq:norms_jac}, and the starred
quantities again refer to boundary and interface conditions implemented via penalization,
in this instance better referred to as numerical fluxes.
%%%%% end replacement
...
are defined identically to \eref{eq:sbp_jac} and defined at the cubature points.
...
the per-block semi-discrete expressions for energy dissipation \eref{eq:sbp_diss} and

...
the Adams-Bashforth coefficients $\boldsymbol{\alpha}$ (see Eqn.~\eref{eq:vandermonde}),
...
to advance this right-hand side via Adams--Moulton (see Eqn.~\eref{eq:am_general}), a Jacobian matrix
...
employ the differential-algebraic approach of Eqn.~\eref{eq:diff_alg_jac}. Additionally, 

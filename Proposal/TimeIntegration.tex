...
on the right side of equation \eref{eq:consmass} - \eref{eq:pres} is typically observed
...
a result, the additive terms \eref{eq:mr_reacting} can be defined as follows:
\begin{align}
